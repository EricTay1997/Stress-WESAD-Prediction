...
ls[[7]] = data.frame(matrix(c(27, 172, 64, 0), nrow = 1, ncol = 4))
...
for (i in 1:15){
  ...
  #ECG_sd = c(ECG_sd, rollapply(subdata$chest_ECG,5, slope, fill = NA))
}
...
for (i in 1:15){
  ...
  #BVP_sd = c(BVP_sd, rollapply(subdata$wrist_BVP, 240,slope, fill = NA))
}
...
* We note that there are no rows with NAs
